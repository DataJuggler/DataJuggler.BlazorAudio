...
namespace DataJuggler.BlazorAudioPlayerDemo.Pages
{
    ...
    public partial class Index : IBlazorComponentParent
    {
        ...
        #region Methods
            ...
            public async void GetCurrentTime()
            {
                ...
                if (HasAudioPlayer)
                {
                    ...
                    currentTime = await AudioPlayer.GetCurrentTime();
            ...
            public void Register(IBlazorComponent component)
            {
                ...
                {
                    // if this is the AudioPlayer in case other components end up on this page
                    if (component is BlazorAudioPlayer)
                    {
                        // Store the AudioPlayer
                        this.AudioPlayer = component as BlazorAudioPlayer;
                    }
        ...
        #region Properties
            ...
            /// <summary>
            /// This property returns true if this object has a 'AudioPlayer'.
            /// </summary>
